...
<div class="main_container;">
 ...
 <!-- <table class="price_table">
  <tr class="price_table_row_heading">
    <th class="price_table_heading">Duration</th>
    <th class="price_table_heading">Price</th>
	<th class="price_table_heading">Despription</th>
  </tr>
  <tr class="price_table_row_data">
    <td class="price_table_data">1 week</td>
    <td class="price_table_data">$150</td>
	<td class="price_table_data">one person</td>
  </tr>
</table> -->
